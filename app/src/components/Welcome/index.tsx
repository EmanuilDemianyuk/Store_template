...
function Welcome():JSX.Element {
    ...
    // }
    return (
        <section className='container flex text-white rounded bg-green-700 mb-5 max-h-max max-w-screen-xl py-2 px-4 lg:px-8 lg:py-4'>
                ...
                {/* <div className='flex relative basis-1/2 w-full flex-wrap md:basis-3/5'>
                        ...
                        <div className='flex basis-1/2'>
                            <div className='p-2 bg-BrandWrapperGB rounded-full'>

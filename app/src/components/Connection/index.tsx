            ...
            <div className='w-11/12 mx-auto'>
                <div className='m-4 flex flex-wrap lg:flex-nowrap'>
                    ...
                    <div className={flexItem}>
                        ...
                        <ul>
                            <li className={li}><i className="fa-solid fa-phone fa-xl" style={{color: '#15803d'}}></i>
                    ...
                    <div className={flexItem}>
                        ...
                        <ul>
                            <li className={li}><i className="fa-solid fa-clock fa-xl" style={{color: '#15803d'}}></i>
                    ...
                    <div className={flexItem}>
                        ...
                        <ul>
                            <li className={li}><i className="fa-solid fa-envelope fa-xl" style={{color: '#15803d'}}></i>
